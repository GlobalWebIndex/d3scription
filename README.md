...
This plugin ties to be as universal as possible.
You can install it using your favorite dependenci manager doesn't matter if you prefere [NPM]() or [bower]().
You can also **directly download distribution**. It supports many  module systems (commonjs, AMD, TypeScript).
It doesn't matter if you want to use it for simple experiment or in complex application everything is as simple as possible.
...
# Usage
You can use this plugin with both **JavaScript and TypeScript**. Please see [demos][demo/] for some examples of usage.

## JavaScript

Assume you have d3scription.js file already loaded in browser or AMD manager is used you're able to use this plugin in similar fashion.
